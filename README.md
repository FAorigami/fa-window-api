...
## 使い方
1. `https://cdn.jsdelivr.net/gh/FAorigami/fa-window-api/FAWindow.js`または`https://cdn.jsdelivr.net/gh/FAorigami/fa-window-api/FAWindow.js?v=001`、`https://cdn.jsdelivr.net/gh/FAorigami/fa-window-api@main/FAWindow.js`を読み込む。
2. 以下のコードで表示：
```javascript
FAWindow.Show(
